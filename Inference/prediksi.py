...
# Sortir secara numerik agar sesuai nomor file (1, 2, ..., 200)
...
print(df_hasil.head(20).to_string(index=False))

output_csv = "prediksi_200_sample.csv"
df_hasil.to_csv(output_csv, index=False)
print(f"\nHasil prediksi 200 sample telah disimpan ke {output_csv}")
